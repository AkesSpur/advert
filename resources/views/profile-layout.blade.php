       ...
       <div x-show="activeFilter === 'age'" class="bg-neutral-900 p-4 rounded-xl max-h-[300px] overflow-y-auto custom-scrollbar">
        ...
        <footer class="pb-6 mt-auto">
            <div class="max-w-screen-2xl border-t border-[#363636] pt-6 mx-auto px-6">
                <!-- Filter Buttons -->
        <div class="flex flex-wrap justify-center justify-center gap-3 mb-4 lg:hidden">
...
<div class="hidden lg:flex flex-wrap  justify-center gap-3 mb-4 ">
    ...
    @endif
                    ...
                    <div class="flex space-x-4">
                        ...
                        <a href="{{ route('register') }}"
                           class="px-4 py-2 bg-transparent shrink-0 text-white border border-white-700 rounded-lg text-sm">
                            Добавить анкету
                        </a>
                        <a href="{{ route('login') }}"
