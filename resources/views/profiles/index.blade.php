<x-app-layout>
    <div class="flex pr-3 pl-3 items-center justify-between mb-4">
        ...
        <a href="{{route('user.form.index')}}" class="px-6 py-2 border border-white-700 rounded-md text-white text-sm transition">
            Добавить анкету
        </a>
    </div>
    ...
    <div class="bg-[#191919] rounded-2xl p-8 text-center">
        ...
        <a href="{{route('user.form.index')}}" class="px-6 py-3 bg-[#6340FF] hover:bg-[#5737e7] text-white rounded-xl text-sm transition inline-block">
            Создать анкету
        </a>
    </div>
    @else
              ...
              <tr class="border-b border-gray-800">
                ...
                <td class="p-4 align-top">
                  <div class="flex items-center justify-end space-x-3">
                    <a href="#" class="px-2 py-1 bg-[#6340FF] hover:bg-[#5737e7] text-white rounded text-xs">Рекламировать</a>
                    <form 
                    action="{{ route('user.profiles.destroy', $profile->id) }}" 
                    method="POST" 
                    class="inline"
                    x-data="{}"
            ...
            <div class="p-5">
                ...
                <div class="text-center mt-5 pb-5 border-b border-gray-800">
                    <div class="flex justify-between mb-2">
                        ...
                        <div class="text-sm text-gray-400">333 435 000</div>
                    </div>
                    <div class="flex justify-between mb-2">
...
>
                    ...
                    <a href="{{route('user.profiles.edit', $profile->id)}}" class="block w-full py-3 bg-[#6340FF] hover:bg-[#5737e7] rounded-xl text-white transition text-center">
                        Редактировать
                    </a>
                </div>
            </div>
